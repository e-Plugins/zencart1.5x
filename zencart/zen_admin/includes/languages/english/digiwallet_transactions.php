...
define('DIGIWALLET_TEXT_CREATE_ORDER', 'Maak bestelling aan');
...
define('DIGIWALLET_TEXT_EXPLANATION', 'Bovenstaande tabel geeft een overzicht van de Digiwallet iDeal transacties 
                ...
                vertoond; dit ziet u aan het bolletje voor ' . DIGIWALLET_TEXT_FILTER_INCOMPLETE .
                ' naast het knopje ' . DIGIWALLET_TEXT_FILTER . '. 
                U kunt daar ook kiezen om ' . DIGIWALLET_TEXT_FILTER_COMPLETE . ' of ' .
                DIGIWALLET_TEXT_FILTER_ALL . ' transacties te laten vertonen. 
                ' . DIGIWALLET_TEXT_FILTER_COMPLETE . ' transacties zijn transacties die afgerond zijn. ' .
