 ...
 */ 
    ...
    define('MODULE_PAYMENT_TARGETPAY_IDE_ERROR_TEXT_TRANSACTION_OPEN', 'The requested payment transaction was canceled/failed');
    define('MODULE_PAYMENT_TARGETPAY_IDE_ERROR_TEXT_TRANSACTION_OPEN', 'The requested payment transaction was canceled/failed');
    define('MODULE_PAYMENT_TARGETPAY_WAL_ERROR_TEXT_TRANSACTION_OPEN', 'The requested payment transaction was canceled/failed');
    define('MODULE_PAYMENT_TARGETPAY_MRC_ERROR_TEXT_TRANSACTION_OPEN', 'The requested payment transaction was canceled/failed');
    define('MODULE_PAYMENT_TARGETPAY_PYP_ERROR_TEXT_TRANSACTION_OPEN', 'The requested payment transaction was canceled/failed');
    define('MODULE_PAYMENT_TARGETPAY_BW_ERROR_TEXT_TRANSACTION_OPEN', 'The requested payment transaction was canceled/failed');
    define('MODULE_PAYMENT_TARGETPAY_DEB_ERROR_TEXT_TRANSACTION_OPEN', 'The requested payment transaction was canceled/failed');
    define('MODULE_PAYMENT_TARGETPAY_CC_ERROR_TEXT_TRANSACTION_OPEN', 'The requested payment transaction was canceled/failed');
    define('MODULE_PAYMENT_TARGETPAY_AFB_ERROR_TEXT_TRANSACTION_OPEN', 'The requested payment transaction was canceled/failed');
    ...
    define('MODULE_PAYMENT_TARGETPAY_AFP_ERROR_TEXT_ERROR_OCCURRED_PROCESSING', 'Er is een fout opgetreden bij het verwerken van uw Afterpay transactie. Kies opnieuw een betaalwijze.');
...
HTML
    ...
    // Refund messsage
    define('MODULE_PAYMENT_TARGETPAY_REFUND_COMMENT_PLACE_HOLDER', 'Uw terugbetalingsbericht ...');
    define('MODULE_PAYMENT_TARGETPAY_REFUND_ERROR_NOT_ENOUGH_AMOUNT', 'U kunt een bedrag niet meer terugbetalen dan de betaling.');
    define('MODULE_PAYMENT_TARGETPAY_REFUND_ERROR_TRANSACTION_NOT_FOUND', 'Transactie is niet gevonden.');
    define('MODULE_PAYMENT_TARGETPAY_REFUND_ERROR_NO_MESSAGE', 'Terugbetalingsbericht kan niet leeg zijn.');
    define('MODULE_PAYMENT_TARGETPAY_REFUND_SUCCESS', 'Uw terugbetaling is succesvol gemaakt.');
    define('MODULE_PAYMENT_TARGETPAY_REFUND_ERROR_AMOUNT', 'Het bedrag moet positief zijn.');
    define('MODULE_PAYMENT_TARGETPAY_DELETE_REFUND_SUCCESS', 'Uw terugbetaling is succesvol verwijderd.');
