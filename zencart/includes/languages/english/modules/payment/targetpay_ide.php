 ...
 */
  ...
  define('MODULE_PAYMENT_TARGETPAY_AFP_ERROR_TEXT_ERROR_OCCURRED_PROCESSING', 'An error occurred while processing your Afterpay transaction. Please select a payment method.');
...
HTML
  ...
  // Refund messsage
  define('MODULE_PAYMENT_TARGETPAY_REFUND_COMMENT_PLACE_HOLDER', 'Your refund message ...');
  define('MODULE_PAYMENT_TARGETPAY_REFUND_ERROR_NOT_ENOUGH_AMOUNT', 'You can\'t refund an amount more than the payment.');
  define('MODULE_PAYMENT_TARGETPAY_REFUND_ERROR_TRANSACTION_NOT_FOUND', 'Transaction was not found.');
  define('MODULE_PAYMENT_TARGETPAY_REFUND_ERROR_NO_MESSAGE', 'Refund message can\'t be empty.');
  define('MODULE_PAYMENT_TARGETPAY_REFUND_SUCCESS', 'Your refund has been created successfully.');
  define('MODULE_PAYMENT_TARGETPAY_REFUND_ERROR_AMOUNT', 'The amount must be a positive number.');
  define('MODULE_PAYMENT_TARGETPAY_DELETE_REFUND_SUCCESS', 'Your refund has been deleted successfully.');
