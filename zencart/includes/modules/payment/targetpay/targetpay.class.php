...
class TargetPayCore
{
    ...
    const MESG_VERSION_REPORT = "(Zencart 1.5, 19-01-2017)";
    ...
    {
        $this->appId = strtolower(preg_replace("/[^a-z\d_]/i", "", $id));
    }
    ...
    public function startPayment()
    {
        ...
        ///$result = "000000 443333442|Captured";
