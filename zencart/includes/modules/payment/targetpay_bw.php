...
class targetpay_bw extends targetpayBase
{
    ...
    public function prepareTransaction()
    {
        ...
        */
        ...
        /*
         ...
         $order->info['order_status'] = constant('MODULE_PAYMENT_TARGETPAY' . $this->payType . 'ORDER_STATUS_ID_OPEN');
         $order->info['comments'] = 'Digiwallet payment: inprogress';

         $order->info['payment_method'] = constant("MODULE_PAYMENT_TARGETPAY" . $this->payType . "TEXT_TITLE");
         ...
         . constant('MODULE_PAYMENT_TARGETPAY' . $this->payType . 'ORDER_STATUS_ID_OPEN')
         . "', last_modified = now() where orders_id = '" . (int) $order_id . "'"
         );
         $db->Execute("update " . TABLE_TARGETPAY_TRANSACTIONS . " set order_id = '". $order_id. "' where transaction_id = '" . $this->transactionID . "'");
