<?php
// Heading
$_['heading_title'] = 'Digiwallet Creditcard Visa/Mastercard';

// Text
$_['text_payment'] = 'Betaling';
$_['text_success'] = 'Gelukt: de Digiwallet instellingen zijn gewijzigd!';
$_['text_edit'] = 'Bewerk Digiwallet ' . $_['heading_title'];
$_['text_creditcard'] = '<a href="https://www.digiwallet.nl" target="_blank"><img src="view/image/payment/visamc.png" alt="Visa/Mastercard via Digiwallet" title="Visa/Mastercard via Digiwallet" style="border: none;" /></a>';
