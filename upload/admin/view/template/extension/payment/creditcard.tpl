          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="creditcard_rtlo" value="<?php echo $creditcard_rtlo; ?>" placeholder="<?php echo $entry_rtlo; ?>" id="entry-rtlo" class="form-control"/>
                  <?php if ($error_rtlo) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="creditcard_test" id="input-test" class="form-control">
                    <?php if ($creditcard_test) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="creditcard_total" value="<?php echo $creditcard_total; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" class="form-control"/>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-status">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="creditcard_pending_status_id" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $creditcard_pending_status_id) { ?>
